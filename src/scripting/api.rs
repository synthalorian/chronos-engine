...
thread_local! {
    static DELTA_TIME: Cell<f64> = const { Cell::new(0.016) };
    static FRAME_COUNT: Cell<i64> = const { Cell::new(0) };
    static TIME_SINCE_START: Cell<f64> = const { Cell::new(0.0) };
    static ENTITY_COUNTER: Cell<i64> = const { Cell::new(0) };
    ...
    static MOUSE_X: Cell<f64> = const { Cell::new(0.0) };
    static MOUSE_Y: Cell<f64> = const { Cell::new(0.0) };
}
